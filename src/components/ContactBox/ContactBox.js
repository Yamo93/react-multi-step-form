...
const contactBox = (props) => {
    return (
        ...
        <Form infoID={props.infoID} loaded={props.loaded} loadingCondition={props.loadingCondition} error={props.errorCondition} userInfo={props.userInfo} changedInfo={props.changedInfo} changedStep={props.changedStep} currentStep={props.currentStep} />
        </div>
    );
};
